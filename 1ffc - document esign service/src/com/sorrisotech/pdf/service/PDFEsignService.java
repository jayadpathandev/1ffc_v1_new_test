...
public class PDFEsignService {
	...
	/**********************************************************************************************
	 * The template pdf form.
	 */
	private PDFDocument templatePdf;
	...
	public boolean addDocumentToSession(
		...
		LOGGER.debug(
				"Adding document to session, pdfDetails : {}, sessionId : {}, accessToken : {}, userFullName : {}, accountNumber : {}", 
				pdfDetails, 
				sessionId, 
				accessToken,
				userFullName,
		...
		final var filledDocument = this.fillPDFDetails(pdfDetails);
		...
		final var documentIndex1 = new DocumentIndex("Full_Name", userFullName);
		final var documentIndex2 = new DocumentIndex("Account_Number", accountNumber);
		
		addDocumentRequest.m_cPartyMappings = List.of(partyMappingDoc);
		addDocumentRequest.m_cFields = List.of(signatureField);
		addDocumentRequest.m_bFlatten = true;
		addDocumentRequest.m_cDocumentIndexes = List.of(documentIndex1, documentIndex2);
	 ...
	 */
	private byte[] fillPDFDetails(Map<String, String> pdfDetails) {
	...
	/**********************************************************************************************
	 * sets the template pdf.
	 * @param templatePdf
	 */
	public void setTemplatePdf(PDFDocument templatePdf) {
