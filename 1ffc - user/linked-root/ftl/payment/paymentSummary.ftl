					...
					<#switch accountStatus>
						<#case "activeAccount">
							...
							<#else>
								...
								<span aria-hidden="true" class="st-help" sorriso="icon-info" data-bs-toggle="tooltip" data-bs-placement="right" title="If you are unable to set up a recurring payment, it may be because you already have a recurring payment scheduled or due to other reasons. Please contact your branch for further details."></span>				
							</#if>
							<#break>
						<#case "newAccount">
						<#case "closedAccount">
