...
import com.sorrisotech.client.main.model.BranchPayload;

/******************************************************************************
 * Holds the information of the all NLS branches response.
 * 
 * @author Asrar Saloda
 */
...
public class BranchResponse {
	...
	private List<BranchPayload> m_cPayLoad;
	 ...
	 */
	public BranchResponse(Integer statuscode, Boolean success, List<BranchPayload> payload,
	...
	public String toString() {
		return "BranchResponse [statuscode=" + m_iStatusCode + ", success=" + m_bSuccess + ", payload="
	 ...
	 */
	public List<BranchPayload> getPayload() {
		return m_cPayLoad;
	}
