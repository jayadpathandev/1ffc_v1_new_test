...
/******************************************************************************
 * Holds the information of the Updated contact preferences Response
 * 
 * @author Asrar Saloda
 */
@JsonInclude(Include.NON_NULL)
public class UpdatedContactPrefrencesResponse {
	...
	public String toString() {
		return "UpdatedContactPrefrencesResponse [statuscode=" + m_iStatusCode + ", success="
		        + m_bSuccess + ", payload=" + m_cPayLoad + ", errors=" + errors + "]";
	}
}
