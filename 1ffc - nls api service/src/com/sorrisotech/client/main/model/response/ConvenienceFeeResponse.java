...
/******************************************************************************
 * Holds the information of the Convenience fee response.
 * 
 * @author Asrar Saloda
 */
...
public class ConvenienceFeeResponse {
	...
	/**************************************************************************
	 * Boolean property to know 3rd party rest call successful or not
	 */
	...
	public String toString() {
		return "MainResponse [statuscode=" + m_iStatusCode + ", success=" + m_bSuccess + ", payload="
		        + m_dPayLoad + ", errors=" + m_cErrors + "]";
	}
	
	/**************************************************************************
	 * Getter method for pay load.
	 * 
	 * @return Double pay load of response.
	 */
